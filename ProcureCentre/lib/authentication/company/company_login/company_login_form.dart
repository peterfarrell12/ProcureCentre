...
class CompanyLoginForm extends StatefulWidget {
  ...
  CompanyLoginForm({Key key, @required UserRepository userRepository, @required companyRepository})
        ...
        if (state.isSuccess) {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) {
              return RegisterScreen(userRepository: _userRepository, companyName: companyName);
            }),
          );
        }
      },
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        CreateCompanyAccountButton(
                            userRepository: _userRepository, companyRepository: _companyRepository,),
                      ],
                    ),
                  ),
                ],
...
class CreateCompanyAccountButton extends StatelessWidget {
  ...
  CreateCompanyAccountButton(
      {Key key, @required UserRepository userRepository, @required CompanyRepository companyRepository})
      : assert(userRepository != null && companyRepository != null),
        _userRepository = userRepository,
        _companyRepository = companyRepository,
        super(key: key);
  ...
  Widget build(BuildContext context) {
    return FlatButton(
      ...
      onPressed: () {
        Navigator.of(context).push(
          MaterialPageRoute(builder: (context) {
            return CompanyRegisterScreen(userRepository: _userRepository, companyRepository: _companyRepository,);
          }),
        );
      },
    );
