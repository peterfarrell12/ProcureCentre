...
class ClassificationScreenStage3Widget extends StatefulWidget {
  ...
  const ClassificationScreenStage3Widget({Key key, this.project, this.company}) : super(key: key);
  @override
  _ClassificationScreenStage3WidgetState createState() => _ClassificationScreenStage3WidgetState();
}

class _ClassificationScreenStage3WidgetState extends State<ClassificationScreenStage3Widget> {
  void onButtonPressed(BuildContext context) {
     BlocProvider.of<ClassificationBloc>(context).add(
                            ClassifyPressed(
                                project: _project, company: _company, modelName: _selected, categories: _selected));
  }
...
String _selected = "";
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                FlatButton(onPressed: () =>onNewDataPressed(context), child: Text(
                                  "Add New Model",
  ...
  itemBuilder: (context, position) {
      return ListTile(
        leading: Icon(Icons.data_usage, color: _selected == models[position] ? Colors.green : Colors.grey,),
        title: Text(models[position]),
        trailing: _selected == models[position] ? Icon(Icons.check, color: Colors.green,) : Text(""),
        onTap:() {
          setState(() {
