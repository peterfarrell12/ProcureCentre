...
//   final tff = Font.ttf(GoogleFonts.openSans());
...
//   //final html.File file = html.File('example.pdf');
//   // file.writeAsBytesSync(pdf.save());
// var file = Uint8List.fromList(pdf.save());

// //  js.context['buildPdf'] = buildPdf;
// //   Timer.run(() {
// //     js.context.callMethod('ready');
// //   });
//   //final bytes = utf8.encode(file.toString());
// final blob = html.Blob([file]);
// final url = html.Url.createObjectUrlFromBlob(blob);
// final anchor = html.document.createElement('a') as html.AnchorElement
//   ..href = url
//   ..style.display = 'none'
//   ..download = 'ThisPDF.pdf';
