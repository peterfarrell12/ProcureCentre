...
//                       padding: const EdgeInsets.all(8.0),
//                       child: FlatButton(
//                         child: Text('Export', style: TextStyle(color: Theme.of(context).primaryColor)),
//                         onPressed: () {
//                           _extractionBloc.add(RetrieveFiles(startTime: sTime ,endTime: DateTime.now(), project: _project, company: _company));
//                         },
//                       ),
//                     ),
//                   ],
...
//                       return ExtractedScreen(projectData: state.data, project: _project, company: _company,);
